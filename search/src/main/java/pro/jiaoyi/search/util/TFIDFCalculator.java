...
public class TFIDFCalculator {
    public static void main(String[] args) {
        List<String> keywords1 = Arrays.asList("关键词1", "关键词2", "关键词3");
//        List<String> keywords2 = Arrays.asList("关键词2", "关键词3", "关键词4");
        List<String> keywords2 = Arrays.asList("关键词2");

        double cosineSimilarity = calculateCosineSimilarity(keywords1, keywords2);
        System.out.println("余弦相似度: " + cosineSimilarity);
    }

    private static double calculateCosineSimilarity(List<String> keywords1, List<String> keywords2) {
